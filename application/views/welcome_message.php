...
<nav class="navbar navbar-default blue darken-4 navbar-fixed">
	...
	<!-- Brand and toggle get grouped for better mobile display -->
		<div class="navbar-header">
		  ...
		  <a class="navbar-brand" href="#" style="color:white"><b>Simple Chatting Application</b></a>
		</div>
		<ul class="nav navbar-nav navbar-right">
			<li><a style="color:white" >Selamat datang <?php echo $this->session->userdata('nama')?></a></li>
			<li><a href="<?php echo site_url('index.php/welcome/keluar')?>" style="color:white" > <i class="fa fa-sign-out"></i></a></li>
		</ul>
	</div>
</nav>
<div class="container">
